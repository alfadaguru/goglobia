<?php
// app/views/notifications/emails/cars/booking_cancellation.php
...
<div style="background: #fff1f2; border-left: 4px solid #e11d48; padding: 20px 32px; margin: 0;">
    ...
    <div style="font-size: 13px; color: #9f1239;">Your request to cancel the car rental booking has been received.</div>
</div>
...
<div style="padding: 32px; background: #f8fafc;">
    ...
    <div style="font-size: 14px; color: #4a5568; margin-bottom: 32px; line-height: 1.6;">
        We have received your cancellation request for car rental booking <strong>#<?= $invoice_id ?></strong>. This request is now being reviewed by our customer support team.
    </div>
    ...
    <div style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px; padding: 16px; margin-bottom: 24px;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                ...
                <td style="padding: 8px 0; color: #2d3748; font-weight: 500; text-align: right; font-size: 14px;"><?= $invoice_id ?></td>
            </tr>
            <tr>
    ...
    <p style="color: #4a5568; font-size: 14px; margin-bottom: 24px; line-height: 1.6;">
        Our team will process your request in accordance with our cancellation policy. We will notify you once the cancellation has been finalized and any applicable refunds have been calculated.
    </p>

    <!-- CTA Button -->
    <div style="text-align: center; margin: 32px 0;">
        <a href="<?= $invoiceUrl ?>" style="display: inline-block; background: #e11d48; color: #ffffff; padding: 14px 32px; border-radius: 6px; text-decoration: none; font-size: 14px; font-weight: 600;">
            View Booking Status
        </a>
    </div>
