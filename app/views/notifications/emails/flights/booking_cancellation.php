<?php
// app/views/notifications/emails/flights/booking_cancellation.php
...
<div style="background: #fff1f2; border-left: 4px solid #e11d48; padding: 20px 32px; margin: 0;">
    ...
    <div style="font-size: 13px; color: #9f1239;">Your request to cancel the flight booking has been received.</div>
</div>
...
<div style="padding: 32px; background: #f8fafc;">
    ...
    <div style="font-size: 14px; color: #4a5568; margin-bottom: 32px; line-height: 1.6;">
        We have received your cancellation request for flight booking <strong>#<?= $booking['invoice_id'] ?></strong>. This request is now being reviewed by our customer support team.
    </div>
    ...
    <p style="color: #4a5568; font-size: 14px; margin-bottom: 24px; line-height: 1.6;">
        Our team will process your request in accordance with the airline's cancellation policy. We will notify you once the cancellation has been finalized and any applicable refunds have been calculated.
    </p>

    <!-- CTA Button -->
    <div style="text-align: center; margin: 32px 0;">
        <a href="<?= root ?>invoice/flights/<?= $booking['invoice_id'] ?>" style="display: inline-block; background: #e11d48; color: #ffffff; padding: 14px 32px; border-radius: 6px; text-decoration: none; font-size: 14px; font-weight: 600;">
            View Booking Status
        </a>
    </div>
