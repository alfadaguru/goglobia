<?php
// mpesa — credential presence check (no stable public verify endpoint wired).
@$SECURE or die('Access Denied!');

$router->post(admin.'/settings/gateway/test/mpesa', function () use ($SECURE, $db) {
    ADMIN_AUTH();
    $g = gw_test_gateway($db, 'mpesa');
    $steps = ['[START] mpesa credential check'];
    $filled = [];
    ...
    $steps[] = '[INFO] A live connection test is not wired for mpesa yet —';
