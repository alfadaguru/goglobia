<?php
// xMoney — credential presence check (no stable public verify endpoint wired).
@$SECURE or die('Access Denied!');

$router->post(admin.'/settings/gateway/test/xmoney', function () use ($SECURE, $db) {
    ADMIN_AUTH();
    $g = gw_test_gateway($db, 'xMoney');
    $steps = ['[START] xMoney credential check'];
    $filled = [];
    ...
    $steps[] = '[INFO] A live connection test is not wired for xMoney yet —';
