 ...
 * 
 * AVAILABLE EVENTS:
 * 1. cars.invoice.viewed - When invoice page is accessed
 * 2. cars.invoice.pdf_generated - When PDF invoice is created
 * 3. cars.invoice.pdf_downloaded - When PDF invoice is downloaded
 * 4. cars.invoice.expired - When booking session expires
 * 
 * =============================================================================
 */
...
if ($event === 'cars.invoice.pdf_downloaded') {
}
