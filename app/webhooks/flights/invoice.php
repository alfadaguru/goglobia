 ...
 * 
 * AVAILABLE EVENTS:
 * 1. flights.invoice.viewed - When invoice page is accessed
 * 2. flights.invoice.pdf_generated - When PDF invoice is created
 * 3. flights.invoice.pdf_downloaded - When PDF invoice is downloaded
 * 4. flights.invoice.expired - When booking session expires
 * 
 * =============================================================================
 */
...
if ($event === 'flights.invoice.pdf_downloaded') {
}
