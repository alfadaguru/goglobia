<?php
// ============================================================================
// GOOGLE FLIGHTS — Refund Request (local only, no API)
// ============================================================================

$router->post('flights/googleflights/refund', function () use ($db) {
    ...
    try {
        ...
        echo json_encode([
            'status'     => true,
            'message'    => 'Refund recorded locally. Google Flights does not provide a refund API — please process the refund directly with the airline.',
            'invoice_id' => $invoice_id,
        ]);
